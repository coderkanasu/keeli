# Epic: Semantic Search (SBERT) Enhancement
...
<!-- @architect breaks this epic into user stories:
     keeli story "<story title>" --epic semantic-search-sbert-enhancement
-->

## Checklist
- [ ] Objective and scope defined
- [ ] User stories created (`keeli story --epic semantic-search-sbert-enhancement`)
