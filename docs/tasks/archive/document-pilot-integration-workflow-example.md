# Task: Document pilot integration workflow example
...
**Story:** map-keeli-artifacts-to-sdlc-systems
**Depends On:** define-sdlc-field-mapping-matrix
**Context:** None
**Persona:** @author

## What
Provide a concrete end-to-end pilot flow for cross-tool traceability.
