# Task: Author KPI reporting cadence and owner model
...
**Depends On:** draft-kpi-metric-dictionary-and-target-bands
**Context:** None
**Persona:** @author

## What
Document weekly and monthly review rituals with clear accountability.
