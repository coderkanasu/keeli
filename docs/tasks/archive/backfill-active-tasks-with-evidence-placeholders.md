# Task: Backfill active tasks with evidence placeholders
...
**Depends On:** update-task-template-to-require-acceptance-evidence
**Context:** None
**Persona:** @developer

## What
Normalize active tasks to new completion standard.
